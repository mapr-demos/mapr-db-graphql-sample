...
public class SortOption {
  ...
  /**
   * Creates new instance of {@link SortOption} according to the specified string, which contains comma-separated list
   * of sort fields and sort type. Note that sort type must occur in string only once. Here is example of valid string:
   * 'name,asc,_id'.
   *
   * @param commaSeparatedFieldsAndOrder string, which contains comma-separated list of sort fields and sort type.
